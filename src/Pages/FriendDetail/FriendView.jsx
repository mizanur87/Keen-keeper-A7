...
const FriendView = ({ expectedFriend }) => {
  const { name, picture } = expectedFriend;
  return (
    <div>
          ...
          <div className="md:col-span-8 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="card bg-white shadow-sm border border-slate-200 p-6 text-center rounded-xl">
                <span className="text-4xl font-bold text-[#244d3f]">62</span>
                <p className="text-xs font-medium text-slate-400 uppercase tracking-tight mt-2">
                  Days Since Contact
                </p>
              </div>
              <div className="card bg-white shadow-sm border border-slate-200 p-6 text-center rounded-xl">
                <span className="text-4xl font-bold text-[#244d3f]">30</span>
                <p className="text-xs font-medium text-slate-400 uppercase tracking-tight mt-2">
                  Goal (Days)
                </p>
              </div>
